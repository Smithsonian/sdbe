...
// rates
//~ #define SWARM_RATE 2496e6 // 6/11 SWARM rate
#define SWARM_RATE 3328e6
...
//~ #define BENG_BUFFER_IN_COUNTS 40 // 6/11 SWARM rate (will likey be replaced by BENG_FRAMES_PER_GROUP)
#define BENG_BUFFER_IN_COUNTS 14 // 8/11 SWARM rate (will likey be replaced by BENG_FRAMES_PER_GROUP)
...
//~ #define DECIMATION_FACTOR 39 // 6/11 SWARM rate
//~ #define EXPANSION_FACTOR 32 // 6/11 SWARM rate
#define DECIMATION_FACTOR 13 // 8/11 SWARM rate
#define EXPANSION_FACTOR 8 // 8/11 SWARM rate
